...
function updateWallSubmissionMode(){
  ...
  warning.textContent=review?'目前处于审核模式中':'目前无需审核直接发布帖子';
...
async function init() {
  ...
  if('serviceWorker' in navigator)window.addEventListener('load',()=>navigator.serviceWorker.register('/sw.js?v=12').catch(()=>{}),{once:true});
