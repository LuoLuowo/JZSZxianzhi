...
revoke all on public.profiles,public.categories,public.site_settings,public.product_code_registry,public.products,public.reservations from anon,authenticated;
